...
class internet_shop:
    ...
    def post(self):
        self._driver.find_element(By.CSS_SELECTOR, "#first-name").send_keys("Alex")
        self._driver.find_element(By.CSS_SELECTOR, "#last-name").send_keys("ZERG")
        self._driver.find_element(By.CSS_SELECTOR, "#postal-code").send_keys("2918")
